...
public class NewReportPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        nextPageButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons and backgrounds/right-arrow.png"))); // NOI18N
        ...
        stuffIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons and backgrounds/application (1).png"))); // NOI18N
        add(stuffIcon);
        stuffIcon.setBounds(610, 440, 30, 40);

        homeIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons and backgrounds/home (2).png"))); // NOI18N
        add(homeIcon);
        homeIcon.setBounds(610, 380, 30, 40);

        foodIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons and backgrounds/diet (1).png"))); // NOI18N
        add(foodIcon);
        foodIcon.setBounds(610, 260, 30, 40);

        travelIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons and backgrounds/globe (1).png"))); // NOI18N
        add(travelIcon);
